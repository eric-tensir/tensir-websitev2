// POST /api/contact — forwards a contact message via Resend.
// Same pattern as /api/careers: no SDK, plain fetch, RESEND_API_KEY env.
...
export async function POST(req) {
  ...
  const res = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      ...
      from: "Tensir Contact <contact@tensir.ai>",
      to: ["eric@tensir.ai"],
      reply_to: email,
